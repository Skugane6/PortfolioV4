// CRJ-900 side-elevation technical profile, redrawn after a blueprint
// reference sheet. The airframe is fully static and intact — nothing here
// splits or slides open. The only dynamic bit is the intro fade/scale
// driven by the `--pi` custom property the caller (Experience.tsx) sets on
// an ancestor element; `--amber` supplies the accent color.
const LABEL_STYLE = {
...
function Callout({
  ...
  return (
    <g>
      <path d={path} fill="none" stroke="#5c6f88" strokeWidth={1} vectorEffect="non-scaling-stroke" />
      <text x={x} y={y} fill="#9fb0c8" textAnchor={anchor} style={LABEL_STYLE} stroke="none">
        {label}
      </text>
    </g>
  );
...
export function PlaneCutawaySvg() {
  return (
    ...
    >
      ...
      {/* Dimension line + intro-only chrome */}
      <g style={{ opacity: 'var(--pi, 0)' }} stroke="#3f4d61" strokeWidth={1} fill="none">
      ...
      {/* Wing + belly fairing — static, sits under the fuselage */}
      <g>
        ...
        {/* winglet-tipped wingtip, angled down off the trailing edge */}
      ...
      {/* Engine nacelle — aft-fuselage mounted, twin-engine CRJ layout */}
      <g>
        <path d="M 1054 241 L 1076 228 L 1080 235 L 1060 247 Z" fill="#28313f" stroke="#7b8ca6" strokeWidth={1} />
        <path
          d="M 1058 228 C 1058 220, 1074 216, 1096 216 C 1122 216, 1140 222, 1140 232 C 1140 242, 1122 248, 1096 248 C 1074 248, 1058 244, 1058 236 Z"
          fill="url(#skinDn)"
          stroke="#8698b0"
          strokeWidth={1.2}
        />
        <ellipse cx={1062} cy={232} rx={5} ry={16} fill="#0d1420" stroke="#8698b0" strokeWidth={1} />
        <path d="M 1140 220 L 1156 224 L 1156 240 L 1140 244" fill="none" stroke="#7b8ca6" strokeWidth={1} />
      </g>

      {/* Main fuselage — single continuous shell, nose junction to tail junction */}
      <g>
        <path
          d="M 330 168 C 520 161, 900 161, 1140 166 C 1232 171, 1300 184, 1342 206
             L 1342 214 C 1300 234, 1240 251, 1140 258 C 900 265, 520 265, 330 258 Z"
          fill="url(#skinUp)"
          stroke="#7b8ca6"
          strokeWidth={1.4}
        />
        ...
        <rect x={686} y={176} width={26} height={36} rx={2} fill="none" stroke="#a3b4cc" strokeWidth={1.1} opacity={0.75} />
      </g>
      ...
      <g>
        ...
        <path d="M 112 216 H 300" stroke="#9fb0c8" strokeWidth={1.5} strokeDasharray="1.5 11" opacity={0.45} />
        <path d="M 252 168 V 259 M 292 167 V 260" stroke="#55647a" strokeWidth={1} opacity={0.55} />
        {/* pitot tube */}
        <path d="M 68 224 L 30 220" stroke="#9fb0c8" strokeWidth={1.2} strokeLinecap="round" />
      </g>
      ...
      {/* Leader-line callouts, matching the blueprint reference */}
      <g style={{ opacity: 'var(--pi, 0)' }}>
        <Callout path="M 20 178 V 118 H 96" label="WEATHER RADAR" x={100} y={121} />
        <Callout path="M 40 224 V 300 H 148" label="PITOT TUBE" x={40} y={318} anchor="start" />
        <Callout path="M 690 138 V 100 H 610" label="VHF / SATCOM ANTENNAS" x={606} y={97} anchor="end" />
        <Callout path="M 359 210 V 330 H 306" label="PASSENGER DOOR (L1)" x={306} y={334} anchor="end" />
        <Callout path="M 699 212 V 336 H 699" label="EMERGENCY EXIT (OVERWING)" x={699} y={352} anchor="middle" />
        <Callout path="M 1099 232 V 344 H 1160" label="ENGINE · GE CF34-8C5" x={1164} y={347} anchor="start" />
        <Callout path="M 1420 224 V 300 H 1470" label="APU (INTERNAL)" x={1474} y={303} anchor="start" />
        <Callout path="M 1530 60 V 20 H 1590" label="T-TAIL" x={1592} y={23} anchor="end" />
      </g>

      {/* Divider between the elevation and the inset row */}
      <g style={{ opacity: 'var(--pi, 0)' }}>
        <path d="M 20 386 H 1580" stroke="#242e3d" strokeWidth={1} />
      </g>

      {/* Front + top view insets, bottom margin */}
      <g style={{ opacity: 'var(--pi, 0)' }} transform="translate(20 408)">
        <text x={0} y={0} fill="#7e8da0" style={LABEL_STYLE} stroke="none">
          FRONT VIEW
        </text>
        <g stroke="#7b8ca6" strokeWidth={1.1} fill="none" transform="translate(0 14)">
          <path d="M 60 70 C 60 46, 76 34, 96 34 C 116 34, 132 46, 132 70" />
          <path d="M 30 66 L 60 58 M 132 58 L 162 66" />
          <path d="M 44 66 L 46 74 L 58 72 M 148 66 L 146 74 L 134 72" />
          <path d="M 88 8 L 104 8 L 100 34 L 92 34 Z" />
          <path d="M 86 70 L 106 70 L 106 78 L 86 78 Z" />
        </g>
      </g>
      <g style={{ opacity: 'var(--pi, 0)' }} transform="translate(280 408)">
        <text x={0} y={0} fill="#7e8da0" style={LABEL_STYLE} stroke="none">
          TOP VIEW
        </text>
        <g stroke="#7b8ca6" strokeWidth={1.1} fill="none" transform="translate(0 14)">
          <path d="M 0 40 C 40 32, 200 32, 260 40 C 200 48, 40 48, 0 40 Z" />
          <path d="M 96 40 L 132 4 L 150 6 L 128 40 M 96 40 L 132 76 L 150 74 L 128 40" />
          <path d="M 232 32 L 256 24 L 260 30 L 240 40 M 232 48 L 256 56 L 260 50 L 240 40" />
        </g>
      </g>
    </svg>
  );
